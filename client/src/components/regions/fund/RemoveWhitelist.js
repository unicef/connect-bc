...
const rows = [
  createData('Chris Fabian', 'mhydary@unicef.org', '0x45876b7DF4E3d6672b7F0c7735D60638C6Cab2eB'),
  createData('Sunita Grote', 'afowler@unicef.org', '0x635c217A06fA76050baE6D798fFfe7af02230a5d'),
  createData('Prateek Upreti', 'crlomazzo@unicef.org', '0xD2DfDc03C2185c50A592080fc9fa7b70DbF38540'),
];
  ...
  return (
    <div className={classes.root}>
      <Typography component='h1' variant='h5'>
        Remove a donor from this region
      </Typography>
