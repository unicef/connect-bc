...
contract StringStorageLogic is Storage {
    ...
    function _setString(bytes32 _key, string memory _value) allowedFactProvider internal {
    ...
    function _getString(address _factProvider, bytes32 _key) internal view returns (bool success, string memory value) {
