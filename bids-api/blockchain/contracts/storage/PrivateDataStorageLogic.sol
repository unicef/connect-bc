...
contract PrivateDataStorageLogic is Storage {
    ...
    /// @param _key The key for the record
    function getPrivateDataHashes(address _factProvider, bytes32 _key) external view returns (bool success, string memory dataIPFSHash, bytes32 dataKeyHash) {
     ...
     */
    function getPrivateDataExchangesCount() public view returns (uint256 count) {
    ...
    function _setPrivateDataHashes(bytes32 _key, string memory _dataIPFSHash, bytes32 _dataKeyHash) allowedFactProvider internal {
    ...
    function _getPrivateDataHashes(address _factProvider, bytes32 _key) internal view returns (bool success, string memory dataIPFSHash, bytes32 dataKeyHash) {
