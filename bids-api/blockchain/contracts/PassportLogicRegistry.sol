...
contract PassportLogicRegistry is IPassportLogicRegistry, Ownable, HasNoEther, HasNoTokens {
     ...
     */
    constructor (string memory _version, address _implementation) public {
     ...
     */
    function addPassportLogic(string memory _version, address _implementation) public onlyOwner {
        _addPassportLogic(_version, _implementation);
    }
     ...
     */
    function setCurrentPassportLogic(string memory _version) public onlyOwner {
        _setCurrentPassportLogic(_version);
    }
    ...
    function _addPassportLogic(string memory _version, address _implementation) internal {
    ...
    function _setCurrentPassportLogic(string memory _version) internal {
